...
def train(model, dataloader, criterion, optimizer, num_epochs=10):
    ...
    for epoch in range(num_epochs):
        ...
        for inputs, labels in dataloader:
            ...
            labels = torch.tensor(labels, dtype=torch.long).to(device)  # 将标签转换为张量并指定 dtype
...
model_names = ['t1\\', 't2', 'flair']
data = loadmat('imageData.mat')['imageData']
